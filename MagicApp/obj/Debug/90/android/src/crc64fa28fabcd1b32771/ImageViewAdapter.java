...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MagicApp.Helper.ImageViewAdapter, MagicApp", ImageViewAdapter.class, __md_methods);
	}
	...
	public ImageViewAdapter ()
	{
		...
		if (getClass () == ImageViewAdapter.class)
			mono.android.TypeManager.Activate ("MagicApp.Helper.ImageViewAdapter, MagicApp", "", this, new java.lang.Object[] {  });
	}

	public ImageViewAdapter (int[] p0, android.content.Context p1)
	{
		super ();
		if (getClass () == ImageViewAdapter.class)
			mono.android.TypeManager.Activate ("MagicApp.Helper.ImageViewAdapter, MagicApp", "System.Int32[], mscorlib:Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
